...
suite('Functional Tests', function() {
  ...
  suite('Routing Tests', function() {
    ...
    suite('GET /api/convert => conversion object', function() {
     ...
     console.log(' initNum '+res.body.initNum+' initUnit '+res.body.initUnit+' returnNum '+Number.isNaN(res.body.returnNum)+' returnUnit '+res.body.returnUnit)
      ...
      test('Convert 32g (invalid input unit)', function(done) {
        ...
        assert.approximately(Number(res.body.returnNum), 32, 0.1);
